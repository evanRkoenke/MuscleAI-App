...
## UI/UX Overhaul — Premium Dark Fitness Theme
- [x] Update theme.config.js with new dark palette: Anabolic Green #39FF14 as primary, deep blacks, subtle grays
- [x] Update tailwind.config.js and theme.config.d.ts with new color tokens (accent, glow, card, etc.)
- [x] Redesign Home/Dashboard: large glowing circular Anabolic Score ring (1-100), premium macro cards with shadows
- [x] Redesign Meals tab with rounded cards and premium styling
- [x] Redesign Track tab with premium weight chart and progress cards
- [x] Redesign Forecast tab with premium styling
- [x] Redesign scan-meal screen with premium dark theme
- [x] Redesign paywall screen with premium dark theme and green accent
- [x] Redesign settings screen with premium dark theme
- [x] Redesign profile screen with premium dark theme
- [x] Redesign onboarding screens with premium dark theme
- [x] Redesign auth screen with premium dark theme
