...
const st = StyleSheet.create({
  ...
  medStatValue: { fontFamily: Typography.fontFamily, fontSize: 12, color: "#F5F5F5" },
  ...
  medLastMealName: { fontFamily: Typography.fontFamily, fontSize: 13, fontWeight: "600", color: "#F5F5F5" },
